...
PERSONA_TITLES_BY_SIGNAL: dict[SignalType, list[str]] = {
    SignalType.PRICE_INCREASE: ["Revenue Operations", "Sales Operations", "VP Sales", "Chief Revenue Officer", "Procurement"],
    SignalType.REVIEW_WAVE: ["Revenue Operations", "Sales Development", "Demand Generation", "Marketing Operations"],
    SignalType.EXECUTIVE_DEPARTURE: ["Chief Revenue Officer", "VP Sales", "Revenue Operations", "Chief Marketing Officer"],
    SignalType.OUTAGE: ["IT", "Security", "Operations", "Engineering", "RevOps"],
