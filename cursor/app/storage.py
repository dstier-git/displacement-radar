...
from .models import CampaignDraft, CompanyProfile, Competitor, CompetitorSignal, Opportunity, ScanResult
...
class Repository:
    ...
    def save_company_profile(self, profile: CompanyProfile) -> None:
        self.store.put("company_profiles", profile)

    def get_company_profile(self) -> CompanyProfile | None:
        return self.store.get("company_profiles", "current", CompanyProfile)
